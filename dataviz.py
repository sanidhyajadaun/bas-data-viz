...
app.layout = html.Div(children=[ 
                                ...
                                html.Div([
                                    # Adding an division
                                    html.Div([
                                        # Creating an division for adding dropdown helper text for report type
                                        html.Div(
                                            [
                                        ...
                                        dcc.Dropdown(id='input-type', 
                                                    ...
                                                    style={'width':'80%','padding':'3px','font-size':'20px','text-Qalign':'center'})
...
def get_graph(chart, year, children1, children2, c3, c4, c5):
        ...
        if chart == 'OPT1':
            ...
            # Returns dcc.Graph component to the empty division
